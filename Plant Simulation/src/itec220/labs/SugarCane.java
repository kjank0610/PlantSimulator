...
public class SugarCane extends Plant {
	...
	public SugarCane(String name) {
		super(name);
		this.primary = Fertilizer.Grass;
		this.secondary = Fertilizer.Jacks;
	}
	...
	public String toString() {
		return String.format("%s the Sugar Cane is listening to %s", this.name, getMusic());
	}
}
